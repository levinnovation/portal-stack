...
import { FormalizacionesCasosScreen } from "@tenants/core/screens/formalizaciones-casos";

export const dynamic = "force-dynamic";

export default async function FormalizacionesCasosPage() {
  return renderCustomScreen({
    title: "Formalizaciones · Casos",
    portalPrefix: "/portal/admin",
    roles: [...AGENT_ADMIN_ROLES],
    action: <AgentHeaderActions />,
    children: <FormalizacionesCasosScreen />,
  });
}
