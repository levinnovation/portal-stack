...
import { InteligenciaEquipoScreen } from "@tenants/core/screens/inteligencia-equipo";
...
export default async function InteligenciaEquipoPage({ searchParams }: PageProps) {
  ...
  return renderCustomScreen({
    ...
    children: <InteligenciaEquipoScreen run={run} />,
  });
}
