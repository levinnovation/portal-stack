...
import { InteligenciaPrediccionesScreen } from "@tenants/core/screens/inteligencia-predicciones";
...
export default async function InteligenciaPrediccionesPage({ searchParams }: PageProps) {
  ...
  return renderCustomScreen({
    ...
    children: <InteligenciaPrediccionesScreen run={run} />,
  });
}
