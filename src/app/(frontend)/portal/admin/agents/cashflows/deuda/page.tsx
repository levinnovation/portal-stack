...
import { CashflowsDeudaScreen } from "@tenants/core/screens/cashflows-deuda";
...
export default async function CashflowsDeudaPage({ searchParams }: PageProps) {
  ...
  return renderCustomScreen({
    title: "Cashflows · Deuda / Fideicomisos",
    portalPrefix: "/portal/admin",
    roles: [...AGENT_ADMIN_ROLES],
    action: <AgentHeaderActions />,
    children: <CashflowsDeudaScreen project={project} />,
  });
}
