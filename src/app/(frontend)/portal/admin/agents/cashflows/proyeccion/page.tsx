...
import { CashflowsProyeccionScreen } from "@tenants/core/screens/cashflows-proyeccion";
...
export default async function CashflowsProyeccionPage({ searchParams }: PageProps) {
  ...
  return renderCustomScreen({
    title: "Cashflows · Proyección de liquidez",
    portalPrefix: "/portal/admin",
    roles: [...AGENT_ADMIN_ROLES],
    action: <AgentHeaderActions />,
    children: <CashflowsProyeccionScreen project={project} />,
  });
}
