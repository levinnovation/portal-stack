...
import { CashflowsFlujoScreen } from "@tenants/core/screens/cashflows-flujo";
...
export default async function CashflowsFlujoPage({ searchParams }: PageProps) {
